...
<head>
  ...
  <ul>
    ...
    <li><a style="text-decoration:none" href="index.php">Contact Us</a></li>
  </ul>
</nav>
</div>
</head>
<body>
  <div id = "join">
    <img src="img/success-2697951.jpg" height="400px" width="600px" align = "right" margin = "10px" class="inline-photo show-on-scroll"/>
  <form method="post">
